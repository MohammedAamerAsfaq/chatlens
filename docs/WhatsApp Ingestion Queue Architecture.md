...
python.exe manage.py run_background_tasks --queue history_ingestion --queue history_embedding_dispatch --queue live_ingestion --queue ai --queue v2_pass1 --queue v2_pass2 --queue embeddings --queue automation --queue outbound
```
