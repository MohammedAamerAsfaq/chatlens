...
> Last updated: 2026-07-17 (§17.2 — 4th connection-reliability incident: root cause found for the recurring `"unexpected error in 'init queries'"` handshake-timeout/stuck-session pattern, traced into Baileys' own source; fix designed but deliberately not yet implemented)
>
> Previous: 2026-07-15 (hot-addable `ProductAttribute` key/value model + UI, product naming & SKU-completion standard documented in §6.8.3)
>
