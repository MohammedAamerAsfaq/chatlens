...
Write-Host "Requesting graceful stop for $ServiceName; active tasks may drain first..."
...
try {
    ...
    throw "$ServiceName did not stop within $TimeoutSeconds seconds. It was not force-killed; use Task Operations to inspect active work."
}
Write-Host "$ServiceName stopped after draining its active work."
