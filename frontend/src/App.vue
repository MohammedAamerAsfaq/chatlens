...
const LOG_ROUTES = ['activity', 'message-logs', 'dropped-messages', 'worker-alerts', 'baileys-events', 'message-trace', 'stuck-receipts', 'unresolved-messages', 'ai-parsing-log', 'ai-parse-v2-log', 'task-operations']
...
const REPORT_ROUTES = ['trading-analytics', 'report-summary', 'inventory-product-mentions', 'selling-offers-report']
    ...
    <nav v-if="auth.user" class="bg-gray-900 text-white px-6 py-3 flex items-center gap-6 shadow shrink-0">
      ...
      <div class="relative group">
        ...
        <div class="absolute left-0 top-full hidden group-hover:block bg-gray-800 border border-gray-700 rounded-lg shadow-lg py-1 min-w-[170px] z-50">
          ...
          <RouterLink to="/selling-offers-report" class="dropdown-item" active-class="dropdown-item-active">Selling Offers Report</RouterLink>
        </div>
      </div>
      ...
      <div class="relative group">
        ...
        <div class="absolute left-0 top-full hidden group-hover:block bg-gray-800 border border-gray-700 rounded-lg shadow-lg py-1 min-w-[170px] z-50">
          ...
          <RouterLink to="/non-inventory-products" class="dropdown-item" active-class="dropdown-item-active">Non-Inventory Products</RouterLink>
      ...
      <div class="relative group">
        ...
        <div class="absolute left-0 top-full hidden group-hover:block bg-gray-800 border border-gray-700 rounded-lg shadow-lg py-1 min-w-[170px] z-50">
          ...
          <RouterLink to="/task-operations"   class="dropdown-item" active-class="dropdown-item-active">Task Operations</RouterLink>
        </div>
      </div>
