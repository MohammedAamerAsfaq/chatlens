...
export const tradingApi = {
  ...
  getNextV2TrainingSample: (params)    => http.get('/v2-match-training/next/', { params }),
  submitV2TrainingSample:  (data)      => http.post('/v2-match-training/submit/', data),
  getV2TrainingStats:      ()          => http.get('/v2-match-training/stats/'),
  ...
  duplicateBuyingInquiry: (id)       => http.post(`/buying-inquiries/${id}/duplicate/`),
  ...
  autoAddAllBuyingInquirySuppliers: (id) => http.post(`/buying-inquiries/${id}/auto-add-all-suppliers/`),
  autoAddAllBuyingInquirySuppliersEmbedding: (id) => http.post(`/buying-inquiries/${id}/auto-add-all-suppliers-embedding/`),
  addAllTaggedBuyingInquirySuppliers: (id) => http.post(`/buying-inquiries/${id}/add-all-tagged-suppliers/`),
  addAllTaggedBuyingInquirySuppliersStrict: (id) => http.post(`/buying-inquiries/${id}/add-all-tagged-suppliers-strict/`),
  addAllPreviouslyContactedBuyingInquirySuppliers: (id) => http.post(`/buying-inquiries/${id}/add-all-previously-contacted-suppliers/`),
  removeAllBuyingInquirySuppliers: (id) => http.post(`/buying-inquiries/${id}/remove-all-suppliers/`),
  ...
  markBuyingInquirySupplierChatLensClick: (id, supplier_id) => http.post(`/buying-inquiries/${id}/mark-supplier-chatlens-click/`, { supplier_id }),
  ...
  markSellingOfferCustomerChatLensClick: (id, customer_id) => http.post(`/selling-offers/${id}/mark-customer-chatlens-click/`, { customer_id }),
