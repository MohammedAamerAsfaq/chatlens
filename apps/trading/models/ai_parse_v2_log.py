...
class AiParseV2Log(models.Model):
    ...
    gate_mode = models.CharField(max_length=20, null=True, blank=True)
    gate_decision = models.CharField(max_length=20, null=True, blank=True)
    gate_request = models.JSONField(null=True, blank=True)
    gate_response = models.TextField(null=True, blank=True)
