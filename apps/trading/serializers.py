...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Product
        fields = ['id', 'name', 'brand', 'category', 'sku', 'aliases', 'attributes', 'is_active', 'tracking',
...
class SellingOfferSerializer(serializers.ModelSerializer):
    ...
    def get_customer_count(self, obj):
        ...
        if 'customers' in prefetched:
            return len(prefetched['customers'])
...
class AutomationRuleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'action_mode', 'zero_unmatched_qty', 'regenerate_price_list', 'sources',
...
class AutomatedPriceCaptureSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'zero_unmatched_qty', 'regenerate_price_list', 'created_at', 'applied_at',
        ]
        read_only_fields = fields
